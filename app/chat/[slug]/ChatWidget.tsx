                ...
                m.copy ? (
                  ...
                  <div>
                    ...
                    <a href={m.wa} target="_blank" rel="noreferrer"
                      style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#25D366', color: '#fff', borderRadius: 10, padding: '10px 14px', fontSize: 15, fontWeight: 700, textDecoration: 'none', width: '100%' }}>
